...
export default function Hero() {
  return (
    <section
      id="mandate"
      className="relative min-h-[80vh] flex flex-col items-center justify-center px-4 overflow-hidden pt-16 pb-12"
    >
      {/* Grid background */}
      <div
        aria-hidden
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(222,255,154,1) 1px, transparent 1px), linear-gradient(90deg, rgba(222,255,154,1) 1px, transparent 1px)',
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at center, rgba(222,255,154,0.07) 0%, transparent 70%)',
        }}
      />

      <div className="relative z-10 max-w-5xl mx-auto text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 bg-[#DEFF9A]/10 border border-[#DEFF9A]/20 rounded-full px-4 py-1.5 mb-10">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold text-white leading-[1.05] mb-6">
          ...
          <span
            ...
            style={{ backgroundImage: 'linear-gradient(135deg, #DEFF9A, #a8f0ff)' }}
          >
            Horizon
          </span>
        </h1>
        ...
        <a
          href="#root-cause"
          className="inline-flex items-center gap-2 bg-[#DEFF9A] hover:bg-[#e8ff9a] text-slate-900 font-bold px-8 py-3.5 rounded-full transition-colors text-sm"
        >
